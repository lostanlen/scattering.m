...
reconstruction_opt.verbosity_period = ...
    default(reconstruction_opt, 'verbosity_period', 10);
...
%% Text generation
reconstruction_opt.generate_text = ...
    default(reconstruction_opt, 'generate_text', false);
