...
if isequal(subscripts,1) && unpadded_signal_size<=hop_signal_size
...
elseif isequal(subscripts,1) && unpadded_signal_size>hop_signal_size
    ...
    offset = hop_signal_size/2 + 1;
    % Special case: first chunk
    lhs_indices = offset:chunk_signal_size;
    rhs_indices = 1:(3*hop_signal_size/2);
    ...
    lhs_indices = 1:(3*hop_signal_size/2);
    rhs_indices = ((1-(3*hop_signal_size/2)):0) + padded_signal_size;
